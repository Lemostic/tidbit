...
export function WindowsTitlebar({ onOpenPalette, onOpenSettings, onDragStart }: DesktopTitlebarProps) {
  ...
  return (
    ...
    >
      ...
      <button onClick={onOpenPalette} className="titlebar__search" title="搜索 (Ctrl+K)">
      ...
      <div className="titlebar__actions">
        ...
        <button className="btn-icon is-danger" aria-label="关闭" title="退出应用" onClick={() => void invoke("app_quit")}>

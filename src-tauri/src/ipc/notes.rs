...
#[tauri::command]
pub async fn notes_list(state: State<'_, AppState>, group_id: Option<i64>) -> Result<Vec<Note>, AppError> {
    state.notes.list_by_group(group_id)
}
...
#[tauri::command]
pub async fn notes_create(state: State<'_, AppState>, group_id: Option<i64>, title: String) -> Result<Note, AppError> {
    state.notes.create_in_group(group_id, &title)
}

#[tauri::command]
pub async fn notes_update_content(state: State<'_, AppState>, id: i64, md: String, html: String, words: i64) -> Result<Note, AppError> {
...
#[tauri::command]
pub async fn notes_set_geometry(state: State<'_, AppState>, id: i64, x: i32, y: i32, w: i32, h: i32) -> Result<(), AppError> {
    state.notes.set_geometry(id, x, y, w, h)
}

#[tauri::command]
pub async fn notes_set_edge_dock(state: State<'_, AppState>, id: i64, edge: String) -> Result<(), AppError> {
